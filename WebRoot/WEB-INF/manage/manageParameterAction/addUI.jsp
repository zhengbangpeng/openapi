...
<form class="form-horizontal" id="addParameterForm"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="required" id="required"
				 placeholder="是否必填(1:必填    0:选填)" required pattern="[0-1]{1}">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-primary" id="addParameter">Save</button>
...
$(function(){
	$("#addParameterForm").submit(function(){
		var form=$(this);
		$.ajax({
			type:'POST',
			url:'manageParameter_add.action',
			data:form.serialize(),
