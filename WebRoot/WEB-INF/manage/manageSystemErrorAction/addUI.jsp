...
<form class="form-horizontal" id="addSystemErrorForm"  method="post">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-primary" id="addSystemError">Save</button>
...
$(function(){
	$("#addSystemErrorForm").submit(function(){
		...
		$.ajax({
			type:'POST',
			url:'manageSystemError_add.action',
			data:form.serialize(),
