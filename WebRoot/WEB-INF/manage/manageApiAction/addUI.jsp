...
<body>
	<div class="container" style="min-width:1280px">
		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-2 col-sm-2">
				<h2 style="text-align:center">API添加</h2>
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				...
				<div class="row">
					<form class="form-horizontal" id="addApiForm" enctype="multipart/form-data" method="post">
						...
						<div class="form-group">
							<label for="pictureUrl" class="col-sm-2 control-label">图片</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button type="submit" class="btn btn-primary" id="addApi">Add</button>
