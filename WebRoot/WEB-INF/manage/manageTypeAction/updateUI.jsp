...
<div class="container" style="min-width:1280px">
		...
		<div class="row">
				...
				<div class="col-lg-2 col-md-2 col-sm-2">
						<h2 style="text-align:center">类型修改</h2>
						...
						<div class="row">
							<form class="form-horizontal" id="updateTypeForm">
								...
								<div class="form-group">
										...
										<div class="col-sm-10">
												 <input type="text" class="form-control" name="name"  placeholder="请输入类型名称" required value="${type.name }"> 
												
										</div>
								</div>
								<div class="form-group">
										<label for="num" class="col-sm-2 control-label">Api数量</label>
										<div class="col-sm-10">
												 <input type="text" class="form-control" name="num"   value="${type.num }" readonly="true"> 
								...
								<div class="form-group">
										...
										<div class="col-sm-10">
												<textarea class="form-control" rows="3"  name="des" >${type.des }</textarea>
										</div>
								</div>
								<div class="form-group">
